...
#this is to store parsed+chunked json metdata
...
def process_file(file_path: str,filename: str, source_type: str):
    ...
    with logfire.span("Processing file",file = filename,source = source_type):
        try:
            ...
            #3. Save processed metdata locally
            processed_data = {
                "filename":filename,
...
def run_universal_ingestion(base_dir: str, explicit_source_type: str=None, wipe:bool = False):
    """ 
    Scan base directory, map sub folders to source types amd ingest all dcouments
    ...
    with logfire.span("Universal Ingestion Started",base_directory = base_dir):
        ...
        #Recreate collection - dimension resolved at runtime using the get_dimension function
        ...
        if not subdirs:
            ...
            logfire.info(f"No subfolders found - processing '{base_dir}' as '{source_type}'. ")
